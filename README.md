...
| descricao | texto | não | é uma descrição da despesa com no máximo 255 caracteres
...
| código | descrição
|-|-
| 201 | dados retornados no corpo da resposta
| 404 | não foi encontrada despesa com id informado
